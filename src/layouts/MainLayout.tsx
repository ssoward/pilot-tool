    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-indigo-600 text-white shadow-md">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <h1 className="text-2xl font-bold">Pilot Tool</h1>
            <nav className="hidden md:flex space-x-6">
              <Link to="/" className="hover:text-indigo-200 transition-colors">Dashboard</Link>
              <Link to="/initiatives" className="hover:text-indigo-200 transition-colors">Initiatives</Link>
      ...
      <footer className="bg-white border-t border-gray-200 py-4">
        <div className="container mx-auto px-4 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} FamilySearch Engineering. All rights reserved.</p>
        </div>
      </footer>
