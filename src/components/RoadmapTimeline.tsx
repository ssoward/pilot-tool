...
interface TimelineItemProps {
  item: RoadmapItem;
  onMove?: (itemId: string, newStartDate: Date, newEndDate: Date) => void;
  onResize?: (itemId: string, newStartDate: Date, newEndDate: Date) => void;
  pixelsPerDay: number;
...
const RoadmapTimeline: React.FC<RoadmapTimelineProps> = (props) => {
  return (
...
const RoadmapTimelineContent: React.FC<RoadmapTimelineProps> = ({
  items,
  milestones,
  onItemMove,
  onItemResize,
  ...
  const [currentView, setCurrentView] = useState<'month' | 'quarter' | 'year'>('quarter');
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        ...
        <div className="flex items-center space-x-2">
          ...
          <select
            value={currentView}
            onChange={(e) => setCurrentView(e.target.value as 'month' | 'quarter' | 'year')}
