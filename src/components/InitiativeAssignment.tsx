...
interface InitiativeAssignmentProps {
  ...
  onAssignTeam: (initiativeId: string, teamId: string, allocation: number) => void;
  onUnassignTeam: (assignmentId: string) => void;
  onUpdateAllocation: (assignmentId: string, allocation: number) => void;
}
...
const InitiativeAssignment: React.FC<InitiativeAssignmentProps> = ({
  initiatives,
  teams,
  assignments,
  onAssignTeam,
  ...
  const getInitiativeAssignments = (initiativeId: string) => {
  ...
  const getTeamUtilization = (teamId: string) => {
  ...
  const isTeamAssigned = (initiativeId: string, teamId: string) => {
  ...
  const startAssignment = (initiativeId: string) => {
